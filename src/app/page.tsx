  ...
  return (
    <div className="flex flex-col items-center min-h-screen">
      <div className="max-w-xl gap-6 flex flex-col mt-8 sm:mt-24 px-4">
        ...
        <p className="text-lg text-zinc-600">
          {`Throughout it all I've had a genuine love of technology and what it can do. The novelty of being able to build anything, and share it with anyone, is yet to wear off on me. Like building a `}<a href="/records" className="underline hover:text-zinc-900 transition-colors">virtual crate with all my records in it</a>{`!`}
        </p>
        <p className="text-lg text-zinc-600">
