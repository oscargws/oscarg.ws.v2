---
date: "2024-05-27"
slug: "transitioning-from-software-to-sales-engineering"
title: "Transitioning from Software Engineering to Sales Engineering"
description: "A rundown of how I made the jump from a hands-on-keys engineer to a customer facing sales engineer"
writing: true
banner: "/img/swe-to-se.jpg"
---
...
<VStack paddingY={4} paddingX={6} borderRadius={8} backgroundColor="gray.100" spacing={3} textAlign="left" alignItems="start">
